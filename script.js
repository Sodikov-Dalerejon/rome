...
function sendMessage() {
    ...
    // if message = developer - show our message
        ...
        setTimeout(() => {
            ...
            appendMessage('bot', 'This Source repacked by Sodikov Daler');
        ...
        appendMessage('user', message);
        setTimeout(() => {
            appendMessage('bot', 'Click X to exit');
            buttonIcon.classList.add('fa-solid', 'fa-paper-plane');
            buttonIcon.classList.remove('fas', 'fa-spinner', 'fa-pulse');
        }, 2001);
        return;
    ...
    const options = {
        ...
        headers: {
            ...
            'X-RapidAPI-Key': '5369a6e6bcmsh1749e762061ff32p112962jsne2282b4216c9',
